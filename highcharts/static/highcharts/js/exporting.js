...
(function (a) {
  "object" === typeof module && module.exports
    ...
    : "function" === typeof define && define.amd
      ? define("highcharts/modules/exporting", ["highcharts"], function (m) {
          a(m);
          a.Highcharts = m;
          return a;
        })
  ...
  a = a ? a._modules : {};
  m(a, "Core/Chart/ChartNavigationComposition.js", [], function () {
    var a;
    (function (a) {
  ...
  m(a, "Extensions/Exporting/ExportingSymbols.js", [], function () {
    ...
    (function (a) {
      ...
      function l(a, e, b, g) {
        ...
        g = [];
        return (g = g.concat(
          this.circle(b - a, e, a, a),
          this.circle(b - a, e + a + 4, a, a),
          this.circle(b - a, e + 2 * (a + 4), a, a),
        ));
      }
      var q = [];
      a.compose = function (a) {
        ...
        A = (function () {
          ...
          b.prototype.close = function () {
            ...
            q(d, "fullscreenClose", null, function () {
              if (
                a.isOpen &&
                a.browserProps &&
                d.container.ownerDocument instanceof Document
              )
                d.container.ownerDocument[a.browserProps.exitFullscreen]();
          ...
          b.prototype.open = function () {
            ...
            q(d, "fullscreenOpen", null, function () {
              n &&
                ((a.origWidthOption = n.width),
                (a.origHeightOption = n.height));
      ...
      var e = a.doc,
        ...
        b = {
          ...
          post: function (a, b, n) {
            ...
            A(b, function (a, b) {
              m("input", { type: "hidden", name: b, value: a }, void 0, d);
            });
            d.submit();
            q(d);
          },
    ...
    function (a, l, m, x, q, D, A, b, g, d) {
      ...
      (function (l) {
        function n(a) {
          ...
          if (!1 !== k.enabled && k.theme) {
            var f = k.theme,
              M;
            c.styledMode ||
              ((f.fill = y(f.fill, "#ffffff")),
              (f.stroke = y(f.stroke, "none")));
            b
              ? (M = function (a) {
                  a && a.stopPropagation();
                  b.call(c, a);
            ...
            k.text && k.symbol
              ? (f.paddingLeft = y(f.paddingLeft, 30))
              : k.text ||
                F(f, { width: k.width, height: k.height, padding: 0 });
            c.styledMode ||
            ...
            var u = v
              ...
              .attr({
                title: y(c.options.lang[k._titleKey || k.titleKey], ""),
              });
            u.menuClassName =
              a.menuClassName || "highcharts-menu-" + c.btnCount++;
            if (k.symbol) {
              var g = v
                .symbol(k.symbol, k.symbolX - e / 2, k.symbolY - e / 2, e, e, {
                  width: e,
                  height: e,
                })
            ...
            u.add(c.exportingGroup).align(
              F(k, { width: u.width, x: y(k.x, c.buttonOffset) }),
              !0,
              "spacingBox",
            );
            c.buttonOffset +=
              (u.width + k.buttonSpacing) * ("right" === k.align ? -1 : 1);
            c.exportSVGElements.push(u, g);
          }
        }
        function x() {
        ...
        function H() {
          ...
          h &&
            this.chartWidth > h &&
            ((b.resetParams = [this.options.chart.width, void 0, !1]),
            this.setSize(h, void 0, !1));
          [].forEach.call(b.childNodes, function (a, c) {
            1 === a.nodeType &&
              ((b.origDisplay[c] = a.style.display),
        ...
        function W(c, h, b, k, e, L, g) {
          ...
          if (!p) {
            ...
            p.hideMenu = function () {
              ...
              g && g.setState(0);
              f.openMenu = !1;
              w(f.renderTo, { overflow: "hidden" });
              w(f.container, { overflow: "hidden" });
              d.clearTimeout(p.hideTimer);
              G(f, "exportMenuHidden");
            };
            f.exportEvents.push(
              B(p, "mouseleave", function () {
            ...
            h.forEach(function (c) {
              "string" === typeof c &&
                (c = f.options.exporting.menuItemDefinitions[c]);
              if (R(c, !0)) {
                var h = void 0;
                c.separator
                  ? (h = E("hr", void 0, void 0, t))
                  : ("viewData" === c.textKey &&
                      f.isDataTableVisible &&
                      (c.textKey = "hideData"),
                    (h = E(
                      "li",
                      {
                    ...
                    a.setElementHTML(h, c.text || f.options.lang[c.textKey]),
                    f.styledMode ||
                      ...
                      w(h, F({ cursor: "pointer" }, v.menuItemStyle || {}))));
                f.exportDivElements.push(h);
              }
            });
            f.exportDivElements.push(t, p);
            f.exportMenuWidth = p.offsetWidth;
            f.exportMenuHeight = p.offsetHeight;
          }
          h = { display: "block" };
          b + f.exportMenuWidth > u
            ? (h.right = u - b - e - n + "px")
            : (h.left = b - n + "px");
          k + L + f.exportMenuHeight > l &&
          "top" !== g.alignOptions.verticalAlign
            ? (h.bottom = l - k - n + "px")
            : (h.top = k + L - n + "px");
          w(p, h);
          w(f.renderTo, { overflow: "" });
          w(f.container, { overflow: "" });
          f.openMenu = !0;
          G(f, "exportMenuShown");
        }
        function X(a) {
          ...
          b &&
            ...
            (b.length = 0));
          c.exportingGroup &&
            (c.exportingGroup.destroy(), delete c.exportingGroup);
          k &&
            (k.forEach(function (a, c) {
              a &&
                (d.clearTimeout(a.hideTimer),
                T(a, "mouseleave"),
                (k[c] =
                  a.onmouseout =
                  a.onmouseover =
        ...
        function ba(a) {
          ...
          e =
            b.exporting.sourceWidth ||
            b.chart.width ||
            (/px$/.test(e) && parseInt(e, 10)) ||
            (b.isGantt ? 800 : 600);
          g =
            b.exporting.sourceHeight ||
            b.chart.height ||
          ...
          this.axes.forEach(function (a) {
            ...
            a.options.isInternal ||
              (l[a.coll] || ((l[a.coll] = !0), (b[a.coll] = [])),
              b[a.coll].push(r(a.userOptions, { visible: a.visible })));
          });
          var f = new this.constructor(b, this.callback);
          a &&
            ["xAxis", "yAxis", "series"].forEach(function (c) {
              var b = {};
          ...
          this.axes.forEach(function (a) {
            ...
            b = b.userMax;
            c &&
              (("undefined" !== typeof h && h !== c.min) ||
                ("undefined" !== typeof b && b !== c.max)) &&
              c.setExtremes(h, b, !0, !1);
          });
          g = f.getChartHTML();
        ...
        function ca(a, b) {
          ...
          return this.getSVG(
            r({ chart: { borderRadius: 0 } }, c.chartOptions, b, {
              exporting: {
          ...
          function a(c) {
            ...
            if (m && 1 === c.nodeType && -1 === fa.indexOf(c.nodeName)) {
              ...
              var n =
                "svg" === c.nodeName
                  ? {}
                  : C.getComputedStyle(c.parentNode, null);
              if (!e[c.nodeName]) {
                g = m.getElementsByTagName("svg")[0];
              ...
              for (var r in k)
                if (
                  ...
                  b.isMS ||
                  b.isSafari ||
                  Object.hasOwnProperty.call(k, r)
                ) {
                  t = k[r];
                  var q = r;
                  l = v = !1;
                  ...
                  for (p = h.length; p-- && !l; )
                    l = h[p].test(q) || "function" === typeof t;
                  l ||
                    (n[q] === t && "svg" !== c.nodeName) ||
                    e[c.nodeName][q] === t ||
                    (O && -1 === O.indexOf(q)
                      ? (f[q] = t)
                      : t && c.setAttribute(da(q), t));
                }
              w(c, f);
              "svg" === c.nodeName && c.setAttribute("stroke-width", "1px");
              "text" !== c.nodeName &&
                [].forEach.call(c.children || c.childNodes, a);
            }
          }
          var h = ha,
            d = l.inlineAllowlist,
            e = {},
            g,
            n = z.createElement("iframe");
          w(n, { width: "1px", height: "1px", visibility: "hidden" });
          z.body.appendChild(n);
          var m = n.contentWindow && n.contentWindow.document;
          m && m.body.appendChild(m.createElementNS(P, "svg"));
        ...
        l.compose = function (a, d) {
          ...
          -1 === K.indexOf(a) &&
            ...
            (d.addButton = n),
            (d.destroyExport = X),
            (d.renderExporting = la),
            d.callbacks.push(V),
            B(a, "init", ja),
            b.isSafari &&
              b.win.matchMedia("print").addListener(function (a) {
                I && (a.matches ? I.beforePrint() : I.afterPrint());
              }));
          -1 === K.indexOf(J) &&
            (K.push(J),
            (e.exporting = r(q.exporting, e.exporting)),
            (e.lang = r(q.lang, e.lang)),
            (e.navigation = r(q.navigation, e.navigation)));
        };
      })(H || (H = {}));
      ("");
      ("");
