    ...
    o(a, "Extensions/NoDataToDisplay/NoDataDefaults.js", [], function () {
      return {
        ...
        noData: {
          ...
          style: { fontWeight: "bold", fontSize: "0.8em", color: "#666666" },
        },
      };
    }),
      o(
        a,
        "Extensions/NoDataToDisplay/NoDataToDisplay.js",
        [
          a["Core/Renderer/HTML/AST.js"],
          a["Extensions/NoDataToDisplay/NoDataDefaults.js"],
          a["Core/Utilities.js"],
        ],
        function (t, a, o) {
          let { addEvent: e, extend: n, merge: s } = o;
          function i() {
            let t = this.series || [],
              a = t.length;
            for (; a--; )
              if (t[a].hasData() && !t[a].options.isInternal) return !0;
          ...
          function r(a) {
            ...
            this.renderer &&
              ...
              this.styledMode ||
                this.noDataLabel
                  .attr(t.filterUserAttributes(s.attr || {}))
                  .css(s.style || {}),
              this.noDataLabel.align(
                n(this.noDataLabel.getBBox(), s.position || {}),
                !1,
                "plotBox",
              ));
          }
      ...
      o(
        a,
        "masters/modules/no-data-to-display.src.js",
        [
          a["Core/Globals.js"],
          a["Extensions/NoDataToDisplay/NoDataToDisplay.js"],
        ],
        function (t, a) {
          return a.compose(t.Chart, t.defaultOptions), t;
        },
      );
  })
);
