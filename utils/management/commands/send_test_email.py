...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        project_url = get_url_with_domain(
            reverse("project:detail", args=[diagnostic.id])
        )
        ...
        diagnostic = request.project
        image_url = (
            "https://creative-assets.mailinblue.com/editor/image_placeholder.png"
        )
        ...
        email = SibTemplateEmail(
            ...
            recipients=[
                {"name": "Team SPARTE", "email": "swann.bouviermuller@gmail.com"}
            ],
            params={
