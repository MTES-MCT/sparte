...
from .DiagnosticDataGouvView import DiagnosticDataGouvView
...
from .DiagnosticResidencesSecondairesView import DiagnosticResidencesSecondairesView
...
__all__ = [
    ...
    "DiagnosticResidencesSecondairesView",
]
