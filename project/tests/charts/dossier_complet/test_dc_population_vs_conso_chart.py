...
def test_dc_population_vs_conso_chart(client, hauts_de_seine):
    response = client.get(
        "/api/chart/dc_population_vs_conso/DEPART/92",
    ...
    assert response.json() == snapshot(
        {
            "highcharts_options": {
                ...
                "chart": {"zoomType": "xy"},
                "title": {"text": "Population et consommation d'espaces - Hauts-de-Seine (2015 - 2020)"},
                "credits": {
                    "enabled": True,
                ...
                "series": [
                    ...
                    },
                    {
                        "name": "Population",
                        "type": "spline",
                        "data": [None, 1603268.0, None, None, None, None],
                ...
                "exporting": {
                    "filename": "Population et consommation d'espaces - Hauts-de-Seine (2015 - 2020)",
            ...
            "data_table": {
                ...
                "rows": [
                    ...
                    {"name": "2016", "data": ["2016", "0.69", "0.22", "1,603,268"]},
