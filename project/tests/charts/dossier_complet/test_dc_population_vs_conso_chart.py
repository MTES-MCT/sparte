...
def test_dc_population_vs_conso_chart(client, metropole_de_lyon):
    response = client.get(
        "/api/chart/dc_population_vs_conso/EPCI/200046977",
    ...
    assert normalize(response.json()) == snapshot(
        {
            "highcharts_options": {
                ...
                "chart": {"zoomType": "xy"},
                "title": {"text": "Population et consommation d'espaces - Métropole de Lyon (2015 - 2020)"},
                "credits": {
                    "enabled": True,
                ...
                "yAxis": [
                    ...
                    {
                        "title": {"text": "Population", "style": {"color": "#FA4B42"}},
                ...
                "series": [
                    ...
                    },
                    {
                        "name": "Population",
                        "type": "spline",
                        "data": [1381249.0, None, None, None, None, None],
                ...
                "exporting": {
                    "filename": "Population et consommation d'espaces - Métropole de Lyon (2015 - 2020)",
            ...
            "data_table": {
                ...
                "rows": [
                    ...
                    {"name": "2016", "data": ["1,381,249", "2016", "28.46", "73.66"]},
                ],
            },
        }
    )
