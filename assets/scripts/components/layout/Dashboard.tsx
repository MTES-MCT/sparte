                ...
                <Routes>
                    ...
                    element={
                      <RouteWrapper
                        ...
                        consoCorrectionStatus={
                          data.consommation_correction_status
                        }
                      >
                  ...
                  <Route
                    ...
                    element={
                      ...
                      >
                        <Impermeabilisation
                          endpoint={urls.impermeabilisation}
                        />
                      </RouteWrapper>
                    }
                  />
                  ...
                  <Route
                    ...
                    element={
                      <RouteWrapper title="Vacance des logements">
                  ...
                  <Route
                    path={urls.update}
                    element={
                      <RouteWrapper title="Paramètres du diagnostic">
