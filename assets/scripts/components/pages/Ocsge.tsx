            ...
            <div className="fr-grid-row">
                <div className="fr-col-12">
                    <Guide
                        ...
                        drawerChildren={
                            <>
                                <p className="fr-text--sm mb-3">Au niveau national, l'artificialisation est mesurée par l'occupation des sols à grande échelle (OCS GE), en cours d'élaboration, dont la production sera engagée sur l'ensemble du territoire national d'ici fin 2024.</p>
                                ...
                                <p className="fr-text--sm mb-3">La couverture du sol est une vue « physionomique » du terrain. La description est une simple distinction des éléments structurant le paysage. Ex : Zones bâties.</p>
                                ...
                                <p className="fr-text--sm mb-3">Chaque objet géographique de l'OCS GE porte ces deux informations. Ex : Zones bâties (couverture) et Agriculture (usage) décrivent des bâtiments agricoles.</p>
                                <div className="d-flex">
                                    <img src={OcsgeNomenclatureUs} alt="OCS GE Nomenclature Us" className="w-100 fr-mr-2w" />
                                    <img src={OcsgeNomenclatureCs} alt="OCS GE Nomenclature Us" className="w-100" />
                                </div>
                            </>
                        }
                    >
