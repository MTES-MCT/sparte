...
const SearchBar: React.FC<SearchBarProps> = ({ createUrl, origin }) => {
  ...
  const shouldQueryBeSkipped =
    debouncedQuery.length < minimumCharCountForSearch;
  const { data: queryData, isFetching } = useSearchTerritoryQuery(
    debouncedQuery,
    {
              ...
              data.map((territory: Territory) => {
                ...
                return (
                  <ResultItem
                    ...
                    onClick={() =>
                      createDiagnostic(territory.public_key, isDisabled)
                    }
                  >
                    <div>
                      <TerritoryTitle>
                      ...
                      <TerritoryDetails>
                        ...
                        {isDisabled && (
                          <div>
                            <i className="bi bi-info-circle fr-mr-1w"></i>
