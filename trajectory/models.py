...
class Trajectory(models.Model):
    ...
    start = models.IntegerField("Année de début", validators=[MinValueValidator(2022), MaxValueValidator(2075)])
    end = models.IntegerField("Année de fin", validators=[MinValueValidator(2022), MaxValueValidator(2075)])
