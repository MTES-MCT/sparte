...
interface ImperUsageSectionProps {
    landData: LandDetailResultType;
}

const ImperUsageSection: React.FC<ImperUsageSectionProps> = ({ landData }) => {
  ...
  return (
    <SectionContainer>
      <SectionTitle>Répartition de l'imperméabilisation par type d'usage</SectionTitle>
      ...
      <>
        ...
        <SubTitle>Flux d'imperméabilisation par type d'usage</SubTitle>
        <Paragraph>
          Ce graphique montre quels usages ont contribué à l'imperméabilisation ou à la
          désimperméabilisation au cours de la période.
        </Paragraph>

        <ChartContainer>
          <GenericChart
            id="imper_flux_by_usage_export"
            land_id={landData.land_id}
            land_type={landData.land_type}
            params={{
...
export default ImperUsageSection;
