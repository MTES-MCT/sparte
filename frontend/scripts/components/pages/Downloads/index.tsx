...
import { ReportCard } from './list';
import { useAuthGuard } from '@hooks/useAuthGuard';
import { CreateReportModal } from './modals';
import { ReportEditor, LoadingState } from './editor';
...
const Downloads: React.FC<DownloadsProps> = ({ landData }) => {
    ...
    const { guardedAction } = useAuthGuard({
        message: "Connectez-vous pour créer et enregistrer des rapports.",
    });
                    ...
                    <>
                        ...
                        <CardsGrid>
                            <ActionCard
                                ...
                                onClick={() => guardedAction(() => handleCreateReportOfType('rapport-complet'))}
                                disabled={isCreating}
                            />
                            ...
                            <ActionCard
                                ...
                                onClick={() => guardedAction(() => handleCreateReportOfType('rapport-local'))}
                                disabled={isCreating}
                            />
                        </CardsGrid>
