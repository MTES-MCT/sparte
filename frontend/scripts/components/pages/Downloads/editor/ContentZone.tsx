    ...
    return (
        <ZoneWrapper onClick={focusEditor}>
            ...
            <Toolbar onClick={(e) => e.stopPropagation()}>
                <Button
                    size="sm"
                    variant={editor.isActive('bold') ? 'primary' : 'tertiary'}
                    type="button"
                    title="Gras (Ctrl+B)"
                ...
                <Button
                    size="sm"
                    variant={editor.isActive('italic') ? 'primary' : 'tertiary'}
                    type="button"
                ...
                <Button
                    size="sm"
                    variant={editor.isActive('bulletList') ? 'primary' : 'tertiary'}
                    type="button"
                    title="Liste à puces"
                    onMouseDown={(e: React.MouseEvent) => {
                        e.preventDefault();
                ...
                <Button
                    size="sm"
                    variant={editor.isActive('orderedList') ? 'primary' : 'tertiary'}
                    type="button"
