...
export const CHART_DESCRIPTIONS = {
  ...
  surfaceProportional: {
    title: "À propos",
    content: "Ce graphique compare la consommation d'espaces NAF proportionnelle à la surface totale du territoire. Les territoires sont représentés sous forme de treemap où la taille reflète la surface du territoire.",
  },
  populationConso: {
    title: "À propos",
    content: "Ce graphique compare la consommation d'espaces NAF au regard de l'évolution démographique. La taille des bulles représente la population totale de chaque territoire. La ligne médiane indique le ratio médian entre évolution démographique et consommation d'espaces NAF.",
  },
} as const;
