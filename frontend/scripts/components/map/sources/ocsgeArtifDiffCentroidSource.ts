...
export class OcsgeArtifDiffCentroidSource extends BaseOcsgeDiffSource {
    ...
    getOptions() {
        const url = `${this.geojsonUrl}artif_diff_centroid_${this.startMillesimeIndex}_${this.endMillesimeIndex}_${this.departement}.geojson.gz`;
    ...
    private async addExtraDepartmentSources(): Promise<void> {
        ...
        for (const dept of deptsForPair) {
            ...
            const url = `${this.geojsonUrl}artif_diff_centroid_${this.startMillesimeIndex}_${this.endMillesimeIndex}_${dept}.geojson.gz`;
