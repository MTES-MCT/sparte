...
La même requête est utilisée pour la table imper_flux_commune.
...
SELECT
    ...
    COALESCE(with_percent.artificial_surface, 0) as artificial_surface,
...
ORDER BY artificial_surface ASC
