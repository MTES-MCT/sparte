...
select
    ...
    {{ common_fields }}
from {{ ref("artif_commune_by_couverture") }}
union all
select
    code as land_id,
    '{{ var("DEPARTEMENT") }}' as land_type,
    {{ common_fields }}
from {{ ref("artif_departement_by_couverture") }}
union all
select
    code as land_id,
    '{{ var("REGION") }}' as land_type,
    {{ common_fields }}
from {{ ref("artif_region_by_couverture") }}
union all
select
    code as land_id, '{{ var("EPCI") }}' as land_type, {{ common_fields }}
from {{ ref("artif_epci_by_couverture") }}
union all
select
    code as land_id, '{{ var("SCOT") }}' as land_type, {{ common_fields }}
from {{ ref("artif_scot_by_couverture") }}
union all
select
    code as land_id, '{{ var("CUSTOM") }}' as land_type, {{ common_fields }}
from {{ ref("artif_custom_land_by_couverture") }}
union all
select
    code as land_id, '{{ var("NATION") }}' as land_type, {{ common_fields }}
from {{ ref("artif_nation_by_couverture") }}
