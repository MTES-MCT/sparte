...
/*
Flux d'artificialisation entre deux millésimes, découpé par zonage d'urbanisme,
...
et `artif_difference_commune`, si bien que la jointure porte d'abord sur
`commune_code`, une égalité sur index btree, et ne fait du spatial que sur le
résidu.

La version précédente croisait les zonages ENTIERS avec `artif_difference`, en
...
with
    difference_zonage_without_surface as (
        ...
        inner join
            {{ ref("artif_difference_commune") }} as ocsge
