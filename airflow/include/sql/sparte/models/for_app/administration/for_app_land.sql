...
SELECT
    ...
    ARRAY[
        ST_XMin(ST_Transform(ST_buffer(geom, 500), 4326)),
        ST_YMin(ST_Transform(ST_buffer(geom, 500), 4326)),
        ST_XMax(ST_Transform(ST_buffer(geom, 500), 4326)),
        ST_YMax(ST_Transform(ST_buffer(geom, 500), 4326))
    ] as max_bounds,
