...
SELECT
    ...
    logements_vacants_commune.is_secretise as is_secretise_prive,
    logements_vacants_commune.secretisation_status as secretisation_status_prive
FROM
...
SELECT
    ...
    logements_vacants_epci.is_secretise as is_secretise_prive,
    logements_vacants_epci.secretisation_status as secretisation_status_prive
FROM
...
SELECT
    ...
    logements_vacants_departement.is_secretise as is_secretise_prive,
    logements_vacants_departement.secretisation_status as secretisation_status_prive
FROM
...
SELECT
    ...
    logements_vacants_region.is_secretise as is_secretise_prive,
    logements_vacants_region.secretisation_status as secretisation_status_prive
FROM
...
SELECT
    ...
    logements_vacants_scot.is_secretise as is_secretise_prive,
    logements_vacants_scot.secretisation_status as secretisation_status_prive
FROM
...
SELECT
    ...
    logements_vacants_custom_land.is_secretise as is_secretise_prive,
    logements_vacants_custom_land.secretisation_status as secretisation_status_prive
FROM
...
SELECT
    ...
    logements_vacants_nation.is_secretise as is_secretise_prive,
    logements_vacants_nation.secretisation_status as secretisation_status_prive
FROM
...
SELECT
    ...
    is_secretise_prive,
    secretisation_status_prive,
    CASE WHEN logements_vacants_parc_general IS NULL OR logements_parc_general IS NULL THEN NULL
         ELSE (logements_vacants_parc_general * 100.0 / NULLIF(logements_parc_general, 0))::double precision
    END as logements_vacants_parc_general_percent,
    CASE WHEN logements_vacants_parc_prive IS NULL OR logements_parc_prive IS NULL THEN NULL
         ELSE (logements_vacants_parc_prive * 100.0 / NULLIF(logements_parc_prive, 0))::double precision
    END as logements_vacants_parc_prive_percent,
    CASE WHEN logements_vacants_parc_social IS NULL OR logements_parc_social IS NULL THEN NULL
         ELSE (logements_vacants_parc_social * 100.0 / NULLIF(logements_parc_social, 0))::double precision
    END as logements_vacants_parc_social_percent,
    CASE WHEN logements_vacants_parc_prive IS NULL OR logements_parc_general IS NULL THEN NULL
         ELSE (logements_vacants_parc_prive * 100.0 / NULLIF(logements_parc_general, 0))::double precision
    END as logements_vacants_parc_prive_on_parc_general_percent,
    CASE WHEN logements_vacants_parc_social IS NULL OR logements_parc_general IS NULL THEN NULL
         ELSE (logements_vacants_parc_social * 100.0 / NULLIF(logements_parc_general, 0))::double precision
