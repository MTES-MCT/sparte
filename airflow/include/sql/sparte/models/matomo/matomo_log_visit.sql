...
SELECt
    ...
    config_resolution,
    config_cookie::int::boolean,
    config_flash::int::boolean,
    config_java::int::boolean,
    config_pdf::int::boolean,
    config_quicktime::int::boolean,
    config_realplayer::int::boolean,
    config_silverlight::int::boolean,
    config_windowsmedia::int::boolean,
    visit_total_time,
    location_city,
    location_country,
    location_latitude,
