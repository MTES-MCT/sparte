...
class LandImperFluxUsageComposition(models.Model):
...
class LandImperFluxUsageCompositionSerializer(serializers.ModelSerializer):
    class Meta:
        model = LandImperFluxUsageComposition
        fields = "__all__"


class LandImperFluxUsageCompositionViewset(generics.ListAPIView):
    queryset = LandImperFluxUsageComposition.objects.all()
    serializer_class = LandImperFluxUsageCompositionSerializer
