...
class LandImperFluxCouvertureCompositionIndex(models.Model):
...
class LandImperFluxCouvertureCompositionIndexSerializer(serializers.ModelSerializer):
    class Meta:
        model = LandImperFluxCouvertureCompositionIndex
        fields = "__all__"


class LandImperFluxCouvertureCompositionIndexViewset(generics.ListAPIView):
    queryset = LandImperFluxCouvertureCompositionIndex.objects.all()
    serializer_class = LandImperFluxCouvertureCompositionIndexSerializer
