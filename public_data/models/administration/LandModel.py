...
class LandModel(models.Model):
    ...
    child_land_types = ArrayField(base_field=models.CharField(), null=True, blank=True)
    ...
    # Null quand le territoire n'a pas de données Cartofriches (has_friche=False)
    friche_status = models.TextField(choices=FricheStatus.choices, null=True, blank=True)
    friche_status_details = models.JSONField(null=True, blank=True)
