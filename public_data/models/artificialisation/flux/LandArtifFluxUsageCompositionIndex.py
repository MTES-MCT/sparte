...
class LandArtifFluxUsageCompositionIndex(models.Model):
...
class LandArtifFluxUsageCompositionIndexSerializer(serializers.ModelSerializer):
    class Meta:
        model = LandArtifFluxUsageCompositionIndex
        fields = "__all__"


class LandArtifFluxUsageCompositionIndexViewset(generics.ListAPIView):
    queryset = LandArtifFluxUsageCompositionIndex.objects.all()
    serializer_class = LandArtifFluxUsageCompositionIndexSerializer
