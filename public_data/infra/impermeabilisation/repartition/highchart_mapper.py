...
class RepartitionOfImpermeabilisationToHighchartMapper:
    @staticmethod
    def map(repartition: RepartitionOfImpermeabilisation) -> dict:
        return {
            "usage": RepartitionOfImpermeabilisationToHighchartMapper._map_usage(usage=repartition.usage),
            "couverture": RepartitionOfImpermeabilisationToHighchartMapper._map_couverture(
                couverture=repartition.couverture
            ),
        }
